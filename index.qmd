...
<a><img src="man/figures/sicher_logo.png" align="right" height="400" width="400"/></a>
...
-   **Constraint Modifiers**: `NonNA()`, `Between()`, `Matches()`, `NonEmpty()` for value-level constraints
...
-   **NonNA**: Rejects any value containing `NA`
-   **Between(min, max)**: Numeric closed-interval range constraint
-   **Matches(pattern)**: Regex-constrained character vectors
-   **NonEmpty**: Rejects zero-length vectors, lists, and zero-row data frames
